...
audio_folder_name = 'data/samples'
audio_file_name = "Patient Consultation with MI.mp3"
audio_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), audio_folder_name, audio_file_name)

if not os.path.exists(audio_path):
    print(f"   ⚠️  File not found, trying alternative...")
    audio_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data/samples", "TalkCPR- A real patient and doctor interaction filmed.mp3")
